...
-- answer |  name   |Vanessa Bruce Barry  Luca  | Sofia | Iman| Diana | Kelsey
...
-- answer | Bruce  | Diana | Brooke | Kenny | Iman | Luca | Taylor | Benista
SELECT name FROM people
...
-- answer | Doris | Sofia | Bruce | Edward | Kelsey | Taylor| Kenny| Luca
...
-- answer Sofia | Kelsey| !!!!!Bruce!!!!!| Kelsey| Taylor| Diana | Carina | Kenny | Benista
